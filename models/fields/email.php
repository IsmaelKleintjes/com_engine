 ...
 * @subpackage  Form
 *
 * @copyright   Copyright (C) 2005 - 2013 Open Assortment Matters, Inc. All rights reserved.
...
class JFormFieldEMail extends JFormField
{
	...
	protected function getInput()
	{
		...
		return '<input type="text" name="' . $this->name . '" class="validate-email' . $class . '" id="' . $this->id . '"' . ' value="'
			. htmlspecialchars($this->value, ENT_COMPAT, 'UTF-8') . '"' . $size . $disabled . $readonly . $onchange . $maxLength . $placeholder . '/>';
	}
}
